 ...
 *
 * Usage (Railway Postgres shell or local with DATABASE_URL):
...
try {
  ...
  // Railway injects DATABASE_URL directly
}

const knex = require(path.join(__dirname, '../server/node_modules/knex'))({
  client: 'pg',
