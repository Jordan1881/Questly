...
export default function TeamJiraBanner({ user }) {
  ...
  return (
    <div className="mb-6 rounded-[10px] border border-[color:var(--color-primary-200)] bg-[color:var(--color-primary-50)] px-4 py-3 text-[length:var(--text-body-sm)] text-[color:var(--color-primary-900)]">
