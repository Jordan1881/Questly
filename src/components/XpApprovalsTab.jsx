...
export default function XpApprovalsTab() {
  ...
  return (
    <div>
      <div className="mb-6">
        <p className="text-[14px] font-semibold text-[#1f2937]">XP Approvals</p>
              ...
              {pendingXpApprovals.map((request) => {
                ...
                return (
                  <tr key={request.id} className={`border-b border-[#f9fafb] transition-colors ${rowBg}`}>
                    <td className={TD}>
                      <p className="font-medium text-[#1f2937]">{request.username}</p>
                      <p className="text-[11px] text-[#9ca3af]">{request.email}</p>
                    </td>
                    <td className={TD}>
                      <p className="font-medium text-[#1f2937]">{request.task_title}</p>
                      <p className="text-[11px] text-[#9ca3af]">{request.jira_issue_key}</p>
                    </td>
                    <td className={TD}>
                      <span className="font-semibold text-[#942fcd]">+{request.xp_amount} XP</span>
                    </td>
